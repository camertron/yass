...
use magnus::{DataTypeFunctions, Error, RArray, Ruby, TypedData, gc, typed_data, value::{Id, Opaque}};
                ...
                for raw_component in iter.by_ref() {
                    let component = match raw_component {
                        ...
                        Component::Where(selector_list) => {
                            YSelectorChild::Where(YWhere::new(selector_list.clone(), ruby))
                        },

                        Component::Is(selector_list) => {
                            YSelectorChild::Is(YIs::new(selector_list.clone(), ruby))
                        },
