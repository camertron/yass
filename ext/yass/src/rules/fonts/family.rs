...
use ::style::values::{computed::font::{FamilyName, FontFamilyList, FontFamilyNameSyntax, GenericFontFamily, SingleFontFamily}, specified::FontFamily};

use crate::cached_value_list::CachedValueList;

pub fn make_font_family(font_family: &FontFamily, ruby: &Ruby) -> Value {
    match font_family {
...
pub fn make_single_font_family(value: &SingleFontFamily, _ctx: &Option<()>, ruby: &Ruby) -> Value {
    match value {
...
#[derive(TypedData)]
#[magnus(class = "Yass::Font::Family::Values", mark)]
...
#[magnus::wrap(class = "Yass::Font::Family::System")]
...
#[magnus::wrap(class = "Yass::Font::Family::Name")]
...
impl YFontFamilyName {
    ...
    pub fn name(_ruby: &Ruby, rb_self: typed_data::Obj<Self>) -> String {
...
#[magnus::wrap(class = "Yass::Font::Family::Generic")]
