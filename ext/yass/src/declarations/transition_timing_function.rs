...
use style::{piecewise_linear::PiecewiseLinearFunction, properties::longhands::transition_timing_function::SpecifiedValue, values::{generics::easing::TimingFunction, specified::{Integer, Number}}};
...
#[derive(TypedData)]
#[magnus(class = "Yass::Declarations::TransitionTimingFunction", mark)]
...
impl DataTypeFunctions for YTransitionTimingFunction {
