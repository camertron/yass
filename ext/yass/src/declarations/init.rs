...
pub fn init(ruby: &Ruby, yass_module: &RModule) -> Result<(), Error> {
    ...
    let _background_blend_mode_class = declarations_module.define_class("BackgroundBlendMode", ruby.class_object())?;
